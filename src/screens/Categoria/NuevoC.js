        ...
        <View style={styles.container}>
                    ...
                    <View
                        ...
                        <ImageBackground
                            ...
                            <View
                                ...
                                <Icon style={{ marginRight: 5 }} name='file-tray-full-outline' color='#000000' size={100} />
                            </View>
                        </ImageBackground>
            ...
            <View style={{ marginTop: 20 }}>
                <View style={styles.action}>
                    <Icon style={{ marginRight: 5 }} name='file-tray-full-outline' color='#000000' size={30} />
                    <TextInput
                ...
                <View style={styles.action}>
                    <Icon style={{ marginRight: 5 }} name='file-tray-stacked-outline' color='#000000' size={30} />
                    <TextInput
            ...
            <View style={{ paddingHorizontal: 30, flexDirection: 'row' }} >
                <TouchableOpacity style={styles.commandButton}
                    onPress={() => navigation.navigate('InicioC')}>
